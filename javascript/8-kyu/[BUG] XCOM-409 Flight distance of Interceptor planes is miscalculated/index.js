// Kata link: https://www.codewars.com/kata/67b7a527c9f842fd3b02adb8/javascript
...
// PREP Method: 
// Parameters: 2 positive numbers (avgSpeed and travelTime)
// Return : the travel distance in kilometers
// Example: (avgSpeed = 600, travelTime = 60) => 1111.2, (avgSpeed = 800, travelTime = 60) => 1481.6

// Pseudocode:
// 1. Does not have the correct constant for KM_PER_MILE (1.852) from nautical miles to kilometers
// 2. travelHours = travelTime / 60 (correct)
// 3. travelMiles = avgSpeed * travelHours (correct)
// 4. should be multiplied not divided => travelKms = travelMiles * KM_PER_MILE
